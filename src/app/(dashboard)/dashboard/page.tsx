...
export default function DashboardPage() {
  ...
  usePageTitle({ pageTitle: t('page_dashboard') });
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <Card key={stat.name} className="overflow-hidden">
            ...
            <div className="mt-4">
              <div className={`text-sm ${stat.changeType === 'increase' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'} flex items-center`}>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card title="Quick Actions">
          <div className="grid grid-cols-2 gap-4">
            <button className="rounded-lg p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors text-left">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Add, edit or remove users</p>
            </button>
            <button className="rounded-lg p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors text-left">
              <FiActivity className="h-6 w-6 text-green-600 dark:text-green-400 mb-2" />
              <p className="text-sm font-medium text-gray-900 dark:text-white">View Reports</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Access analytics and reports</p>
            </button>
            <button className="rounded-lg p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors text-left">
              <FiCheckCircle className="h-6 w-6 text-purple-600 dark:text-purple-400 mb-2" />
              <p className="text-sm font-medium text-gray-900 dark:text-white">Create Task</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Add new tasks to the system</p>
            </button>
            <button className="rounded-lg p-4 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors text-left">
              <FiAlertCircle className="h-6 w-6 text-red-600 dark:text-red-400 mb-2" />
              <p className="text-sm font-medium text-gray-900 dark:text-white">System Settings</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Configure system preferences</p>
            </button>
          </div>
        </Card>
      </div>
